<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Labo__2_Apsx.Login" %>
...
<body>
 <h2>Login...</h2> <hr />
    <form id="form1" runat="server">
         <div style="margin:auto; width:300px; background-color:lightgray; padding:20px; border:1px solid black;">
             <table>
                 <tr>
                 ...
                 <tr>
                     ...
                     <td>
                          <asp:Button ID="BTN_Login" runat="server" Text="Soumettre..." class="submitBTN" ValidationGroup="VG_Login"/>
                     </td>
                 </tr>
